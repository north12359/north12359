// 动态心跳
$(doucument).ready(function(e){
     $('.copyright').html('©2021 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By 在北方');
})
...
BirthDay=new Date("6/30/2023 13:00:00");
today=new Date();
